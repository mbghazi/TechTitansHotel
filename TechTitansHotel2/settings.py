"""
Django settings for TechTitansHotel2 project.
...
DATABASES = {
    'default': {
        ...
        'NAME': 'HotelMainDB',  # Replace with your actual database name
        'USER': 'postgres',
        'PASSWORD': '5722',
        'HOST': 'localhost',  # Set to the address of your database
        'PORT': '5432',  # Leave as is if using the default PostgreSQL port
    }
}
...
STATICFILES_DIRS = [
    ...
    os.path.join(BASE_DIR, 'static'),  # Path to React app's build output
]
